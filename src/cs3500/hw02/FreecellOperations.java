...
public interface FreecellOperations<K> {
   ...
   *
   * <p></p>An invalid deck is defined as a deck that has one or more of these flaws:
   * <ul>
   ...
   *
   * <p></p>It deals the deck among the cascade piles in roundrobin fashion. Thus if
